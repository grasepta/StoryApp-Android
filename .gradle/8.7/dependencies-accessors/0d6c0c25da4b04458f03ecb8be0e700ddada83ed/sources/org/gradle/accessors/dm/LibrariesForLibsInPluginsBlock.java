...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final ProtoLibraryAccessors laccForProtoLibraryAccessors = new ProtoLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>retrofitScalars</b> with <b>com.squareup.retrofit2:converter-scalars</b> coordinates and
     * with version reference <b>retrofitScalar</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getRetrofitScalars() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("retrofitScalars");
    }
    ...
    /**
     * Group of libraries at <b>preferences</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public PreferencesLibraryAccessors getPreferences() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForPreferencesLibraryAccessors;
    }

    /**
     * Group of libraries at <b>proto</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public ProtoLibraryAccessors getProto() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForProtoLibraryAccessors;
    }
    ...
    public static class GlideLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>annotation</b> with <b>com.github.bumptech.glide:compiler</b> coordinates and
         * with version reference <b>glideVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getAnnotation() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("glide.annotation");
        }
    ...
    public static class NavigationFragmentLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>navigation.fragment.ktx</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class NavigationUiLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>navigation.ui.ktx</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class PreferencesLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getDatastore() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("preferences.datastore");
        }
     ...
     */
    @Deprecated
    public static class ProtoLibraryAccessors extends SubDependencyFactory {

        public ProtoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>datastore</b> with <b>androidx.datastore:datastore-core</b> coordinates and
         * with version reference <b>dataStoreVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
    ...
    public static class SwipeLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>layout</b> with <b>androidx.swiperefreshlayout:swiperefreshlayout</b> coordinates and
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidxNavigationSafeargsGradlePlugin</b> with value <b>2.7.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>hiltVersion</b> with value <b>2.48.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kspVersion</b> with value <b>1.9.20-1.0.14</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>retrofitScalar</b> with value <b>2.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRetrofitScalar() { return getVersion("retrofitScalar"); }
    ...
    public static class NavigationVersionAccessors extends VersionFactory  {
        ...
        /**
         * Group of versions at <b>versions.navigation.fragment</b>
         */
        ...
        /**
         * Group of versions at <b>versions.navigation.ui</b>
         */
    ...
    public static class NavigationFragmentVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>navigation.fragment.ktx</b> with value <b>2.5.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class NavigationUiVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>navigation.ui.ktx</b> with value <b>2.5.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
